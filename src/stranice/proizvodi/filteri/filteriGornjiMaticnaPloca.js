...
export class FilteriGornjiMaticnaPloca extends Component {
    constructor(props) {
      super(props);
      this.state = {
        filteri:[]
    ...
    render()
      ...
      <Link to="#" className="slct"><select id="cenaDo" onChange={this.props.filter}>
             ...
             <option value="ddo35" >&lt; 35 000</option>
             <option value="dpreko35" >&gt; 35 000</option>
         </select></Link>
    ...
    export default (FilteriGornjiMaticnaPloca);
