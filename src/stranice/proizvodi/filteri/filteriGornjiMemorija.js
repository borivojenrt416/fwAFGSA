...
export class FilteriGornjiMemorija extends Component {
    constructor(props) {
      super(props);
      this.state = {
        filteri:[]
    ...
    render()
      ...
      <Link to="#" className="slct"><select id="cenaDo" onChange={this.props.filter}>
             ...
             <option value="ddo5" >&lt; 5 000</option>
             <option value="ddo15" >&lt; 15 000</option>
    ...
    export default (FilteriGornjiMemorija);
