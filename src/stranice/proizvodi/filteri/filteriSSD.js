    ...
    render()
      {
          return(
            ...
            <div className="inside">
             ...
             <input type="checkbox" name="Do 335MB" id="Do 335MB" value="Do 335MB" onChange={this.props.checkChanged}/>
               <label htmlFor="Do 335MB">Do 335MB</label><br/>
               <input type="checkbox" name="Do 520MB" id="Do 520MB" value="Do 520MB" onChange={this.props.checkChanged}/>
               <label htmlFor="Do 520MB">Do 520MB</label><br/>
               <input type="checkbox" name="Do 550MB" id="Do 550MB" value="Do 550MB" onChange={this.props.checkChanged}/>
               <label htmlFor="Do 550MB">Do 550MB</label><br/>
               <input type="checkbox" name="Do 2100MB" id="Do 2100MB" value="Do 2100MB" onChange={this.props.checkChanged}/>
               <label htmlFor="Do 2100MB">Do 2100MB</label><br/>
               <input type="checkbox" name="Do 2200MB" id="Do 2200MB" value="Do 2200MB" onChange={this.props.checkChanged}/>
               <label htmlFor="Do 2200MB">Do 2200MB</label><br/>
               <input type="checkbox" name="Do 3350MB" id="Do 3350MB" value="Do 3350MB" onChange={this.props.checkChanged}/>
               <label htmlFor="Do 3350MB">Do 3350MB</label><br/>
               <input type="checkbox" name="Do 3500MB" id="Do 3500MB" value="Do 3500MB" onChange={this.props.checkChanged}/>
             ...
             <input type="checkbox" name="Do 500MB" id="Do 500MB" value="Do 500MB" onChange={this.props.checkChanged}/>
               <label htmlFor="Do 500MB">Do 500MB</label><br/>
               <input type="checkbox" name="Do 520MB" id="Do 520MB" value="Do 520MB" onChange={this.props.checkChanged}/>
               <label htmlFor="Do 520MB">Do 520MB</label><br/>
               <input type="checkbox" name="Do 1150MB" id="Do 1150MB" value="Do 1150MB" onChange={this.props.checkChanged}/>
               <label htmlFor="Do 1150MB">Do 1150MB</label><br/>
               <input type="checkbox" name="Do 1200MB" id="Do 1200MB" value="Do 1200MB" onChange={this.props.checkChanged}/>
               <label htmlFor="Do 1200MB">Do 1200MB</label><br/>
               <input type="checkbox" name="Do 2000MB" id="Do 2000MB" value="Do 2000MB" onChange={this.props.checkChanged}/>
               <label htmlFor="Do 2000MB">Do 2000MB</label><br/>
               <input type="checkbox" name="Do 2300MB" id="Do 2300MB" value="Do 2300MB" onChange={this.props.checkChanged}/>
               <label htmlFor="Do 2300MB">Do 2300MB</label><br/>
               <input type="checkbox" name="Do 2800MB" id="Do 2800MB" value="Do 2800MB" onChange={this.props.checkChanged}/>
